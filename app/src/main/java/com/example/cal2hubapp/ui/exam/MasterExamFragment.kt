package com.example.cal2hubapp.ui.exam
...
import com.example.cal2hubapp.databinding.FragmentMasterExamBinding

class MasterExamFragment : Fragment() {

    private var _binding: FragmentMasterExamBinding? = null
    ...
    private var answeredQuestions = mutableSetOf<Int>() // Track answered questions to avoid double counting
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMasterExamBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun loadQuestions() {
        questions = contentRepository.getRandomQuizQuestions(50)
        if (questions.size < 50) {
            // Optionally show a warning or handle fewer questions
        }
    ...
    private fun setupClickListeners() {
        ...
        binding.submitButton.setOnClickListener { submitExam() }
    }
    ...
    private fun submitExam() {
        ...
        if (currentUser != null) {
            val isPassed = score >= 38
            val result = QuizResult(
                userId = currentUser.username,
                chapterId = "master_exam",
                score = score,
